...
INSERT INTO `account` VALUES ('sachin','sachin','123','Your Lucky Number?','17'),('pooja','pooja','pagal','Your Lucky Number?','7');
...
CREATE TABLE `hotel` (
  ...
  `acroom` varchar(20) DEFAULT NULL,
  `foodincluded` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `hotel` VALUES ('Hotel Paradise','3400','1000','1700'),('Castle inn','2400','1600','2600'),('Castle inn','2400','1600','2600'),('Hotel Royal inn ','4400','2000','2900');
...
-- Dump completed on 2025-04-29 23:36:12
